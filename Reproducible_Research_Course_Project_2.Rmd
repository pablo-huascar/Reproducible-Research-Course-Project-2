...
There was a peak in injuries between 1997 and 1999. When analyzing data from this period, we see many injuries due to floods and tornadoes. 
...
Podemos também avaliar o tipo de evento que causou o maior montante no período disponível nos dados. Somados todos os prejuídos, as inundações são o evento mais catastrófico economicamente, seguido dos furacões
...
noaa_data_health_damage %>% 
  ...
  ggplot(aes(evtype_rcd,
             total), color = fct_reorder(evtype_rcd,
                                         media(total)))+
  geom_bar(stat = indenti)
