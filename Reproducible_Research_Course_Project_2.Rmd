...
As indicated in the table below tornadoes cause the most fatalities and injuries across the United States.
...
On the map below, the states are colored by total fatalities by tornadoes.
...
tornado_fatalities_plot|tornado_injuries_plot 
